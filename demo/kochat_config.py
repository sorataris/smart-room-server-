...
DATA = {
    ...
    'NER_categories': ['DATE', 'LOCATION', 'RESTAURANT', 'PLACE','OBJECT','DO','ROOM'],  # 사용자 정의 태그  나중애 chat도 추가해보자
    'NER_tagging': ['B', 'E', 'I', 'S'],  # NER의 BEGIN, END, INSIDE, SINGLE 태그ㅏㅏㅓㅏ
    'NER_outside': 'O',  # NER의 O태그 (Outside를 의미)
    #태깅방식은 B,E,I,S  -LOCATION/등등 있는거 같다.
    #ODD데이터는 일종의 예외처리같은 비스무리한 기능으로 현재 기능에서 지원되지않는 데이터셋이다
}
...
GENSIM = {
    ...
    'iter': 1000  # 임베딩 학습 횟수 수정됨 기본 2000
}
...
INTENT = {
    ...
    'epochs': 20,  # 인텐트 학습 횟수 수정됨 기본 1000
